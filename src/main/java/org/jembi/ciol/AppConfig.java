...
public final class AppConfig {
    ...
    public static final Integer MAIL_SMTP_PORT = CONFIG.getInt("mail.smtp.port");
    public static final String MAIL_SMTP_USERNAME = CONFIG.getString( "mail.smtp.username");
    public static final String MAIL_SMTP_PASSWORD = CONFIG.getString( "mail.smtp.password");
